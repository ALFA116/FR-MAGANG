...
<body>
    <div class="home-pri">
                    ...
                    <div class="container-6 d-flex justify-content-center align-items-center">
                        ...
                        <div class="product-solutions navbar-item dropdown">
                            ...
                            <div class="dropdown-content" id="dropdownMenu">
                                <a href="ip-telephony-solution.php" class="active">IP Telephony Solution</a>
        ...
        <div class="ip-telephony-wrapper">
            <div class="ip-telephony-container">
                <div class="ip-telephony-header">
                    <div class="ip-telephony-title">IP Telephone Solution</div>
                    <p class="ip-telephony-subtitle">
                        <span class="highlight">Lets Fix Issue&nbsp;&nbsp;</span> <span>With Innovation</span>
                    </p>
                </div>
                <div class="ip-telephony-content-wrapper">
                    <div class="ip-telephony-content">
                        <div class="ip-telephony-section">
                            <div class="ip-telephony-icon">
                                <img src="../assets/img/kal.png" alt="SIP Trunking Icon" style="margin-top: -321px; margin-left: -15px;" />
                            </div>
                            <div class="ip-telephony-details">
                                <h2 style="margin-bottom: 15px;">SIP TRUNKING</h2>
                                <p2>SIP Trunk enables your business to reduce costs</br></p2>
                                <p2 style="margin-left: -86px;">and simplify IT management.</p2>
                                <p style="margin-bottom: 25px;">
                                    SIP Trunk enables your business to reduce costs and simplify IT management by combining voice and
                                    Internet access using existing IP PBX system or hosted PBX. Scalable for large number of lines and
                                    for multi-location business, more features without additional equipment.
                                </p>
                                <p class="benefits" style="font-size: 20px;">
                                    <strong>Benefit:</strong> scalable for large number of lines and for multi–location business, more features without
                                    additional equipment.<br />
                                    <strong>Target Market:</strong> multi–national companies, call center, virtual office.
                                </p>
                            </div>
                        </div>
                        <div class="ip-telephony-image" style="margin-right: -2px;">
                            <img src="../assets/img/ip(1).png" alt="Diagram" />
                        </div>
                    </div>
                    <div class="ip-telephony-content reverse">
                        <div class="ip-telephony-image2" style="margin-left: -75px;">
                            <img src="../assets/img/ip(2).png" alt="Diagram" />
                        </div>
                        <div class="ip-telephony-section">
                            <div class="ip-telephony-icon2">
                                <img src="../assets/img/jam.png" alt="Hosted PABX Icon" style="margin-top: -274px;" />
                            </div>
                            <div class="ip-telephony-details">
                                <h3 style="margin-bottom: 15px;">HOSTED PABX</h3>
                                <p1>Hosted PBX is a cloud-based PBX system.</p1>
                                <p style="margin-bottom: 25px;">
                                    Accessible via an IP network. It also provides businesses with the ability to manage their phone
                                    systems and has more features than traditional PBX.
                                </p>
                                <p class="benefits" style="font-size: 20px;">
                                    <strong>Benefit:</strong> scalable for large number of lines and for multi–location business, more features without
                                    additional equipment.<br />
