...
<body>
    <div class="home-pri">
                    ...
                    <div class="container-6 d-flex justify-content-center align-items-center">
                        ...
                        <div class="product-solutions navbar-item dropdown">
                            ...
                            <div class="dropdown-content" id="dropdownMenu">
                                ...
                                <a href="design-testing.php" class="active">Design &amp; Testing</a>
        ...
        <!-- TAMPILAN ip-telephony-solution -->
        <div class="ip-telephony-container">
            <div class="ip-telephony-header" style="margin-left: 65px;">
                <div class="ip-telephony-title">Design & Testing Solution</div>
            ...
            <div class="ip-telephony-content">
                <div class="ip-telephony-section">
                    <div class="design-testing-icon">
                        <img src="../assets/img/pensil(icon).png" alt="SIP Trunking Icon" style="margin-top: -218px; margin-left: 40px;" />
                    </div>
                    <div class="ip-telephony-details">
                        <h2 style="margin-bottom: 15px;">UI/UX DESIGN</h2>
                        <p2>We specialize in designing application designs for</br></p2>
                        <p2 style="margin-left: -86px;">businesses.</p2>
                        <p style="margin-bottom: 25px;">
                            we creater wireframes and mockups for the appearance and usser experience ( UI/UX ) of the app These designs should be easy to use and visually appealing. And devolep interactive prototypes that showcase the app flow and basic functionallty to get early feedback from stakeholders
                        </p>
                    </div>
                </div>
                <div class="ip-telephony-image" style="margin-right: -56px;">
                    <img src="../assets/img/design(1).png" alt="Diagram" />
                </div>
            </div>
            <div class="ip-telephony-content reverse">
                <div class="ip-telephony-image2" style="margin-left: -20px;">
                    <img src="../assets/img/design(2).png" alt="Diagram" />
                </div>
                <div class="ip-telephony-section">
                    <div class="design-testing-icon2">
                        <img src="../assets/img/monitor(icon).png" alt="Hosted PABX Icon" style="margin-top: -162px;" />
                    </div>
                    <div class="ip-telephony-details">
                        <h3 style="margin-bottom: 15px;">MOBILE & WEBSITE</h3>
                        <p1>Mobile Application & website Services.</p1>
                        <p style="margin-bottom: 25px;">
                            we also provide advance programs from design to original, for all your bussines or industry needs, whether Mobile or website Application based
                        </p>
                    </div>
                </div>
            </div>
            <div class="ip-telephony-content">
                <div class="ip-telephony-section">
                    <div class="design-testing-icon3">
                        <img src="../assets/img/setting(icon).png" alt="SIP Trunking Icon" style="margin-top: -179px; margin-left: 40px;" />
                    </div>
                    <div class="ip-telephony-details">
                        <h2 style="margin-bottom: 15px;">TESTING & MAINTENANCE APLICATION</h2>
                        <p style="margin-bottom: 25px;">
                            Testing for mobile application and websites, both for the disiplay and behind the scannes. this i done ta ensure that the application built is worthy of being published and used publicly by clients.
                        </p>
                        <p style="margin-bottom: 25px;">
                            Then we can also perform maintenance on your application, bath in terms af appearance and application security.
                        </p>
                    </div>
                </div>
                <div class="ip-telephony-image" style="margin-right: -56px;">
                    <img src="../assets/img/design(3).png" alt="Diagram" />
                </div>
            </div>
        </div>
